...
*Trinity* is a fully chained exploit for the *PS Vita™* consisting of six unique vulnerabilities. It is based on a decade of knowledge and research. The source of of *Trinity* can be found [here](<https://github.com/TheOfficialFloW/Trinity>).
...
In the second case, we're done. We've already found a free chunk can can simply coalesce with our current chunk.
